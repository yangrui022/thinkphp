...
<div class="main">
    ...
    <div class="container-fluid" id="content_list">
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="row noticeList">
            <a href="<?php echo U('detail?id='.$vo['id']);?>">
                <div class="col-xs-3">
                    <p class="title text-info ">报修人：<?php echo ($vo["username"]); ?> </p>
                </div>
                <div class="col-xs-6">
                    <p class="title">报修标题：<?php echo ($vo["title"]); ?></p>

                </div>
                <div class="col-xs-push-3">
                    <p class="title text-danger">
                        <?php echo ($vo['status']==1?'处理中':'处理成功'); ?>                         </p>
                </div>
            </a>
    ...
    <script type="application/javascript">
        var p = 1;
        var url = '/Wechat.php?s=/Repair/myrepair';
        var inner_url = '/Wechat.php?s=/Repair/detail';
        $(function(){
                            ...
                            for(index in list){
                                ...
                                html += '<div class="row noticeList">\
                                 <a href="'+inner_url+'/id/'+list[index].id+'.html">\
                                    <div class="col-xs-3">\
                                        <p class="title text-info ">报修人：'+list[index].username+'</p>\
                                    </div>\
                                    <div class="col-xs-6">\
