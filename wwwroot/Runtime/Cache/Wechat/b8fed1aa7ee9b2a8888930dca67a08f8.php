...
<div class="main">
    ...
    <div class="container-fluid">
        ...
        <div class="noticeDetailInfo">发布者:小区物管<?php echo ($info["name"]); ?></div>
        <div class="noticeDetailInfo">发布时间：<?php echo date('Y-m-d',$info['add_time']);?></div>
        <div class="noticeDetailInfo">联系电话：<?php echo ($info["tel"]); ?></div>
        <h4 class="text-danger">价格:<?php echo ($info["price"]); echo $info['unit']==1?'月/元':'万/元';?></h4>
        <div class="noticeDetailContent">
            <img src="<?php echo (get_cover($info["img"],'path')); ?>" />
        </div>
    </div>
</div>
