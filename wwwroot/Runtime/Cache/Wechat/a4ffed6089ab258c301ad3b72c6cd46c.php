...
<div class="main">
    ...
    <div class="container-fluid">
        <div class="blank"></div>
        <h3 class="noticeDetailTitle"><strong>标题：<?php echo ($info["title"]); ?></strong></h3>
        <div class="noticeDetailInfo">发布者:<?php echo ($info["username"]); ?><span class="pull-right">状态：<span class="text-danger"><?php echo $info['status']==1?'处理中':'处理完成';?></span></span></div>
        <div class="noticeDetailInfo">发布时间：<?php echo date('Y-m-d H:i:s',$info['create_time']);?></div>
        <div class="noticeDetailContent">
          <?php echo ($info["content"]); ?>    </div>
    </div>

    <form action="/Repair/detail/id/52.html" method="post">
        <div class="form-group container-fluid">
            <label>评论:</label>
            <textarea name="comment" class="form-control" required></textarea>
            <p><input class="btn btn-primary ajax-post" type="submit" value="发表评论"></p>
        </div>
    </form>
