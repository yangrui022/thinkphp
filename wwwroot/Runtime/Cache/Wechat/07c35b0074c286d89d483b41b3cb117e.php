...
<div class="main">
    ...
    <div class="container-fluid" style="margin-top: 5%;">
        <form action="/Repair/repair.html" method="post">
            ...
            <div class="controls" style="margin-bottom: 20px;">
                <img class="verifyimg reloadverify" alt="点击切换" onclick="this.src='/Wechat.php?s=/Wechat/verify.html'" src="<?php echo U('User/verify');?>" style="cursor:pointer;height: 40px;">
            </div>
            <div class="form-group">
