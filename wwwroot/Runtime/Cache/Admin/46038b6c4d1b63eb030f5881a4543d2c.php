					...
					<div class="form-item cf">
						...
						<div class="controls">
							...
							<select style="width: 200px;" name="unit">
								<option value="1"  <?php echo ($info['unit']==1)?'selected':'';?> >元/月</option>
								<option value="2" <?php echo ($info['unit']==2)?'selected':'';?>>万元</option>
							</select>
						</div>
					</div>
					<div class="form-item cf">
						<div class="form-item cf">
							...
							<div class="controls">
								<select style="width: 200px;" name="type">
									<option value="1"  <?php echo ($info['type']==1)?'selected':'';?>>出租</option>
									<option value="2"  <?php echo ($info['type']==2)?'selected':'';?>>销售</option>
								</select>
							</div>
						</div>
						<div class="controls">
							...
							<input type="hidden" name="img" id="img" value="<?php echo ((isset($info["img"]) && ($info["img"] !== ""))?($info["img"]):''); ?>"/>
