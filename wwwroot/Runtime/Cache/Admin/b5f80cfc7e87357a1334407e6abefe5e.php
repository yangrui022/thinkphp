...
<body>
    ...
    <div class="tab-wrap">
        <div class="tab-content">
            <!-- 表单 -->
            <form id="form" action="/admin.php/Sale/add.html" method="post" class="form-horizontal">
                <!-- 基础文档模型 -->
                <div id="tab1" class="tab-pane tab1 in">
                    ...
                    <div class="form-item cf">
                        ...
                        <div class="controls">
                            ...
                            <input type="hidden" name="" id="cover_id_path"/>
                        ...
                        <script type="text/javascript">
                            ...
                            $("#upload_picture_path").uploadify({
                                ...
                                "buttonText": "上传图片",
                                "uploader": "/admin.php/File/uploadPicture/session_id/s2266mtv3sd7ksdt7nloq3s915.html",
                                "width": 120,
                                'removeTimeout': 1,
                        ...
                        <div class="form-item cf">
                            ...
                            <div class="controls">
                                <input type="text" class="text time" name="end_time" value=""></div>
                        </div>
                        <div class="form-item cf">
                            <label class="item-label">联系人电话</label>
                            <div class="controls">
                                <input type="text" class="text input-large" name="tel" value=""></div>
                        </div>
                    </div>
                    <div class="form-item cf">
